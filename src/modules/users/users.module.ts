...
@Module({
  imports: [TypeOrmModule.forFeature([UsersEntity,CoursesEntity, UserlogEntity, LogcontrolEntity, RefreshTokenEntity]), PasswordModule, 
  ], 

  controllers: [UsersController],
  providers: [UsersService, UserlogService, LogControlService, AuthService, CoursesService],
